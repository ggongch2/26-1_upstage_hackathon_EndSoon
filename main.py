...
from pipeline import docx_builder, glossary as glossary_mod, parser as parser_mod, solar as solar_mod
...
async def translate(
    ...
    try:
        parser = parser_mod.from_env()
        solar = solar_mod.from_env()
    except RuntimeError as e:
        raise HTTPException(500, str(e))

    log.info("job %s :: Document Parse start", job_id)
